...
Esse documento contém a análise exploratória referente aos dados de Inclusão Financeira contidas no Sistema de Gerenciamento de Séries (SGS) do Banco Central do Brasil. O foco é em Instituições Emissoras de Moeda Eletrônica.
