...
#####MEI PJ: SALDO REAL DE CRÉDITO, JUROS E INADIMPLÊNCIA POR MODALIDADE#####
...
ipca_index_ano2<-rbind(ipca_index_ano,ipca_index_ano,ipca_index_ano,ipca_index_ano,
                       ipca_index_ano,ipca_index_ano,ipca_index_ano,ipca_index_ano,ipca_index_ano) #colocando 8 índices um abaixo do outro
...
saldomodmeipj_data[a:b,3]<-"Aquisição de Bens - Outros Bens"
saldomodmeipj_data[(a+b*1):(b+b*1),3]<-"Aquisição de Bens - Veículos Automotores"
saldomodmeipj_data[(a+b*2):(b+b*2),3]<-"Capital de Giro com Prazo de Vencimento até 365d"
saldomodmeipj_data[(a+b*3):(b+b*3),3]<-"Capital de Giro com Prazo Superior a 365d"
saldomodmeipj_data[(a+b*4):(b+b*4),3]<-"Cartão de Crédito - Compra à Vista e Parcelado Lojista" 
saldomodmeipj_data[(a+b*5):(b+b*5),3]<- "Cheque Especial"
saldomodmeipj_data[(a+b*6):(b+b*6),3]<-"Desconto de Cheques"
saldomodmeipj_data[(a+b*7):(b+b*7),3]<-"Desconto de Duplicatas"
...
jurosmodmeipj_data[a:b,3]<-"Aquisição de Bens - Outros Bens"
jurosmodmeipj_data[(a+b*1):(b+b*1),3]<-"Aquisição de Bens - Veículos Automotores"
jurosmodmeipj_data[(a+b*2):(b+b*2),3]<-"Capital de Giro com Prazo de Vencimento até 365d"
jurosmodmeipj_data[(a+b*3):(b+b*3),3]<-"Capital de Giro com Prazo Superior a 365d"
jurosmodmeipj_data[(a+b*4):(b+b*4),3]<- "Cheque Especial"
jurosmodmeipj_data[(a+b*5):(b+b*5),3]<-"Desconto de Cheques"
jurosmodmeipj_data[(a+b*6):(b+b*6),3]<-"Desconto de Duplicatas"
...
inadmodmeipj_data[a:b,3]<-"Aquisição de Bens - Outros Bens"
inadmodmeipj_data[(a+b*1):(b+b*1),3]<-"Aquisição de Bens - Veículos Automotores"
inadmodmeipj_data[(a+b*2):(b+b*2),3]<-"Capital de Giro com Prazo de Vencimento até 365d"
inadmodmeipj_data[(a+b*3):(b+b*3),3]<-"Capital de Giro com Prazo Superior a 365d"
inadmodmeipj_data[(a+b*4):(b+b*4),3]<- "Cheque Especial"
inadmodmeipj_data[(a+b*5):(b+b*5),3]<-"Desconto de Cheques"
inadmodmeipj_data[(a+b*6):(b+b*6),3]<-"Desconto de Duplicatas"
